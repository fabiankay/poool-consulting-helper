...
def _get_field_examples():
    ...
    return {
        ...
        'customer_number_client': 'Our internal customer number for this client (e.g., "CUST-001", "K-12345")',
        'client_number': 'Their external client/reference number (e.g., "EXT-001", "REF-123")',
        'payment_time_day_num_client': 'Payment terms in days for client (e.g., "30", "14")',
        'comment_client': 'Client-specific notes and comments',
        'send_bill_to_email_to': 'Primary invoice email address (e.g., "billing@client.com")',
        'send_bill_to_email_cc': 'CC email for invoices (e.g., "accounting@client.com")',
        'send_bill_to_email_bcc': 'BCC email for invoices (e.g., "archive@client.com")',
        ...
        'dunning_document_blocked': '1/0 or true/false - block dunning document generation',
        'send_by_email': '1/0 or true/false - send invoices by email',
        'send_by_mail': '1/0 or true/false - send invoices by postal mail',
        'number_unique': 'Unique client identifier number (e.g., "U-12345")',
        'datev_account_client': 'DATEV accounting code for client (e.g., "1200", "KR001")',

        # Supplier-specific fields
        'supplier_number': 'Our internal supplier number for this supplier (e.g., "SUP-001", "L-12345")',
        'customer_number_supplier': 'Their customer number for us (how they reference us, e.g., "C-001")',
